      ...
      <main className="he-main">
        ...
        <section className="he-hero">
          <div className="he-hero__left">
            <p className="he-hero__label">Gestionando</p>
            <h1 className="he-hero__name">{restName}</h1>
            <div className="he-hero__meta">
              {restCity && <span className="he-hero__tag"><MapPin size={14} />{restCity}</span>}
              {restRating && <span className="he-hero__tag he-hero__tag--star"><Star size={14} fill="currentColor" />{Number(restRating).toFixed(1)}</span>}
            </div>
        ...
        <section className="he-stats">
          <div className="he-stat he-stat--visits">
            ...
            <div>
              <span className="he-stat__value">{visits.length}</span>
              <span className="he-stat__label">Visitas recientes</span>
            </div>
          </div>
          <div className="he-stat he-stat--customers">
            <div className="he-stat__icon"><Users size={20} /></div>
            <div>
              <span className="he-stat__value">{new Set(visits.map(v => v.customer_id)).size}</span>
              <span className="he-stat__label">Clientes únicos</span>
            </div>
          </div>
          {restRating && (
            <div className="he-stat he-stat--rating">
              ...
              <div>
                <span className="he-stat__value">{Number(restRating).toFixed(1)}</span>
                <span className="he-stat__label">Valoración media</span>
              </div>
            </div>
          )}
        </section>
